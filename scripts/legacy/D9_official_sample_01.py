...
if __name__ == '__main__':
    ...
    print("STEP 1: before creating Standalone application", flush=True)
    zos = PythonStandaloneApplication()
    print("STEP 2: Standalone application created", flush=True)
    ...
    # 为了兼容 Zemax OpticStudio 19.4，把官方示例输出保存到自己的项目 results 文件夹
    output_dir = r"C:\Users\20181\Desktop\Zemax\02_zosapi_python\results"
    os.makedirs(output_dir, exist_ok=True)

    #! [e01s01_py]
    # Make new file
    testFile = os.path.join(output_dir, "D9_e01_new_file_and_quickfocus.zmx")
    print("Save path:", testFile)

    TheSystem.New(False)
    TheSystem.SaveAs(testFile)
    print("SaveAs finished")
    #! [e01s01_py]
